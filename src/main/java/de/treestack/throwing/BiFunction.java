...
public interface BiFunction<T1, T2, R, E extends Exception> {
     ...
     */
    @Nullable
    R apply(@Nullable T1 t1, @Nullable T2 t2) throws E;
     ...
     * @since 1.0
     */
    static <T1, T2, R, E extends Exception> java.util.function.BiFunction<T1, T2, Optional<R>> lifted(
            final BiFunction<? super T1, ? super T2, R, E> function
    ) {
        return (t1, t2) -> {
            try {
     ...
     * @since 1.0
     */
    static <T1, T2, R, E extends Exception> java.util.function.BiFunction<T1, T2, R> unchecked(
            final BiFunction<? super T1, ? super T2, R, E> function) {
        return (t, t2) -> {
            try {
